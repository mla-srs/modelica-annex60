...
model MoverStages
  ...
  extends Annex60.Fluid.Movers.Examples.MoverParameter(
    pump_Nrpm(inputType=Annex60.Fluid.Types.InputType.Stages),
    pump_m_flow(inputType=Annex60.Fluid.Types.InputType.Stages),
    pump_y(inputType=Annex60.Fluid.Types.InputType.Stages),
    pump_dp(inputType=Annex60.Fluid.Types.InputType.Stages));
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(file=
          "modelica://Annex60/Resources/Scripts/Dymola/Fluid/Movers/Examples/MoverStages.mos"
        "Simulate and plot"),
